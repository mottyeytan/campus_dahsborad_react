...
export default function FilterBar(){
    ...
    return (
        <div className='filter-bar'>
            ...
            <button className= "grid-view"  onClick={LayoutView} >GRID VIEW </button>
            <button className= "list-view" onClick={LayoutView}>LIST VIEW </button>

            </div>


            <div className= "search-bar">
                <input type='text' placeholder='Search for an Event' onChange={SearchEvent} />
            </div>
